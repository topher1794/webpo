                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="actionupload.php" method="post" enctype="multipart/form-data">
                            ...
                            <input name="userno" value="<?php echo  $_SESSION["userno"]; ?>" hidden />
                            <input name="plantcode" value="<?php echo  $_SESSION["plantcode"]; ?>" hidden />
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="accttype" id="accttype" class="custom-select form-control-border" id="exampleSelectBorder">
                                        ...
                                        foreach ($acct as $k) {
                                        ?>
                                            <option data-id="<?php echo $k["accttype"]; ?>"><?php echo $k["accttype"]; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
